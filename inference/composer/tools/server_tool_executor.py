...
async def _execute_web_search(args: Dict[str, Any]) -> str:
    ...
    from composer.tools.static.web_search_tool import (  # pylint: disable=import-outside-toplevel
        web_search,
    )
...
async def _execute_web_fetch(args: Dict[str, Any]) -> str:
    ...
    from composer.tools.static.web_reader_tool import (  # pylint: disable=import-outside-toplevel
        read_web_content,
    )
