    ...
    async def _arun(self, content: str) -> str:
        ...
        try:
            ...
            try:
                ...
                # Try to get a pipeline for summarization
                # For static tool, we'll use any available text generation model
                try:
                    ...
                    # In a real implementation, this would come from user config
