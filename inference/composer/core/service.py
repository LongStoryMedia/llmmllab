...
class ComposerService:
    ...
    async def compose_workflow(
        ...
        try:
            ...
            if self.workflow_cache:
                ...
                if cached_workflow:
                    self.logger.debug("Retrieved workflow from cache", extra={"cache_key": cache_key})
            ...
            if self.workflow_cache:
                workflow = await self.workflow_cache.get_or_create(cache_key, builder_fn)
            else:
            ...
            self.logger.info(
                ...
                extra={
                    ...
                    "user_id": conversation_ctx.user_config.user_id if conversation_ctx.user_config else None
                }
            )
    ...
    async def _analyze_intent(self, conversation_ctx: ConversationCtx) -> "IntentAnalysis":
        """
