...
class WorkflowCache:
    ...
    def get_cache_key(
        ...
        key_data = {
            ...
            "model_profile": user_config.model_profiles.primary_profile.id if user_config and user_config.model_profiles else "default",
            "tools": sorted([tool.id for tool in tools]),
            "preferences": user_config.preferences.dict() if user_config and user_config.preferences else {}
        }
    ...
    async def set(self, cache_key: str, workflow: Any, ttl_seconds: Optional[int] = None) -> None:
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        async with self._lock:
            ...
            return {
                ...
                "hit_rate": 0.0 if total_accesses == 0 else (total_accesses - total_entries) / total_accesses
            }
