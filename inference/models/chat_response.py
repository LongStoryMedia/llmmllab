# Code generated by schema2code at 2025-10-23 11:37:49. DO NOT EDIT.
...
class ChatResponse(BaseModel):
    ...
    thinking: Optional[Thought] = Field(default=None, description="The thinking/reasoning process from the assistant before the response")
    """The thinking/reasoning process from the assistant before the response"""
    tool_calls: Optional[List[ToolExecutionResult]] = Field(default=None, description="Optional tool calls associated with the message")
    ...
    analyses: Optional[List[IntentAnalysis]] = Field(default=None, description="Analytical insights or summaries related to the chat response")
