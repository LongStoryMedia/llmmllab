...
"""
    ...
    current_user_message: Annotated[Optional[Message], Field(default=None, description="The current message from the user")]
    """The current message from the user"""
    intent: Annotated[Optional[Intent], Field(default=None, description="The intent detected from the user's message")]
