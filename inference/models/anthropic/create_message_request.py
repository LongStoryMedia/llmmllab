...
class Metadata(BaseModel):
    user_id: Annotated[Optional[str], Field(default=None, description="External identifier for the user (uuid or opaque id, no PII).")] = None
    """External identifier for the user (uuid or opaque id, no PII)."""
