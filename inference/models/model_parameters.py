...
class ModelParameters(BaseModel):
    ...
    micro_batch_size: Optional[int] = Field(default=None, description="Micro batch size for processing inputs")
    """Micro batch size for processing inputs"""
    n_gpu_layers: Optional[int] = Field(default=None, description="Number of model layers to keep on GPU for performance optimization", ge=-1)
    ...
    kv_on_cpu: Optional[bool] = Field(default=False, description="Store key-value cache on CPU to save GPU memory")
