...
class ResearchSubtask(BaseModel):
    ...
    question: Annotated[Optional[ResearchQuestion], Field(default=None, description="The research question this subtask addresses")]
    """The research question this subtask addresses"""
    result: Annotated[Optional[ResearchQuestionResult], Field(default=None, description="Synthesized result of the subtask")]
    ...
    error_message: Annotated[Optional[str], Field(default=None, description="Error message if subtask failed")]
