...
class NodeMetadata(BaseModel):
    ...
    conversation_id: Optional[int] = Field(
        default=None, description="Conversation identifier for this execution context"
    )
    """Conversation identifier for this execution context"""
    profile_type: Optional[ModelProfileType] = Field(
        default=None, description="Model profile type for pipeline execution"
    )
    ...
    cache_key: Optional[str] = Field(
        default=None, description="Cache key used for pipeline caching"
    )
    """Cache key used for pipeline caching"""
    tool_count: Optional[int] = Field(
        default=None, description="Number of tools available or executed", ge=0
    )
