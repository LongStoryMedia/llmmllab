...
class LangGraphState(BaseModel):
    ...
    messages: List[Message] = Field(..., description="Sequence of messages")
    ...
    tools_used: List[str] = Field(default=[], description="List of tools or functions that have been used in the workflow")
    """List of tools or functions that have been used in the workflow"""
    intermediate_results: Dict[str, Any] = Field(default={}, description="Storage for intermediate computation results during workflow execution")
