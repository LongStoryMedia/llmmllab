...
class ModelDetails(BaseModel):
    ...
    n_layers: Annotated[int, Field(..., description="Number of layers in the model")]
    """Number of layers in the model"""
    hidden_size: Annotated[int, Field(..., description="Hidden size of the model")]
    """Hidden size of the model"""
    n_heads: Annotated[int, Field(..., description="Number of attention heads in the model")]
    """Number of attention heads in the model"""
    n_kv_heads: Annotated[int, Field(..., description="Number of key-value heads in the model")]
