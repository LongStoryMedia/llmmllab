...
class ModelProfile(BaseModel):
    ...
    parameter_optimization: Optional[ParameterOptimizationConfig] = Field(default=None, description="Configuration for parameter optimization during model initialization")
    """Configuration for parameter optimization during model initialization"""
    draft_model: Optional[str] = Field(default=None, description="Optional draft model to use for faster initial responses")
