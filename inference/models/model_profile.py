...
class ModelProfile(BaseModel):
    ...
    id: Optional[uuid.UUID] = Field(
        default=None, description="Unique identifier for the profile"
    )
    ...
    created_at: Optional[datetime] = Field(
        default=None, description="Timestamp of when the profile was created"
    )
    ...
    model_version: Optional[str] = Field(
        default=None, description="Version of the model"
    )
    """Version of the model"""
    type: int = Field(..., description="Type of the model profile")
    """Type of the model profile"""
    image_settings: Optional[ModelProfileImageSettings] = Field(
        default=None, description="Image settings for the model profile"
    )
    ...
    gpu_config: Optional[GPUConfig] = Field(
        default=None,
