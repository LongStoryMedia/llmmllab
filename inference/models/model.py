...
class Model(BaseModel):
    ...
    id: Annotated[Optional[str], Field(default=None, description="Unique identifier for the model")]
    ...
    pipeline: Annotated[Optional[str], Field(default=None, description="Pipeline type used for the model (e.g., \"sd3\", \"sdxl\")")]
    """Pipeline type used for the model (e.g., \"sd3\", \"sdxl\")"""
    lora_weights: Annotated[Optional[List[LoraWeight]], Field(default=None, description="List of LoRA weights associated with the model")]
