...
class TestTextExtraction:
    ...
    def test_extract_text_mixed_content_types(self):
        ...
        content = [
            MessageContent(type=MessageContentType.TEXT, text="Hello", url=None),
            MessageContent(type=MessageContentType.IMAGE, text=None, url="http://example.com/image.jpg"),
            MessageContent(type=MessageContentType.TEXT, text=" world", url=None),
        ]
        message = Message(
            role=MessageRole.USER,
...
class TestMessageConversion:
    ...
    def test_message_to_lc_message_assistant(self):
        ...
        content = [MessageContent(type=MessageContentType.TEXT, text="Hi there", url=None)]
        message = Message(
...
class TestNormalization:
    ...
    def test_normalize_message_input(self):
        ...
        original_message = Message(
            role=MessageRole.ASSISTANT,
            content=[MessageContent(type=MessageContentType.TEXT, text="Already a message", url=None)],
            created_at=datetime.now(timezone.utc),
        )
