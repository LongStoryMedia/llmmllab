    ...
    try:
        ...
        if run_script_path.exists():
            with open(run_script_path) as f:
                ...
                if 'run_composer' in run_script_content and run_script_content.count('run_composer') >= 2:
        ...
        if k8s_service_path.exists():
            with open(k8s_service_path) as f:
                ...
                if 'port: 8001' in k8s_service_content and 'targetPort: 8001' in k8s_service_content:
        ...
        if k8s_deployment_path.exists():
            with open(k8s_deployment_path) as f:
                ...
                if 'name: composer' in k8s_deployment_content and 'containerPort: 8001' in k8s_deployment_content:
        ...
        print("  ✅ Dockerfile creates composer virtual environment and installs package")
        print("  ✅ Container exposes composer port 8001 with proper environment variables")
        print("  ✅ v.sh script supports composer environment with cross-module imports")
        ...
        print("  k exec -it -n ollama $POD_NAME -- /app/v.sh composer python -m uvicorn app:app --port 8001")
        print("  k exec -it -n ollama $POD_NAME -- /app/v.sh composer python debug/test_composer_phase1.py")
        print("\n  # Local development:")
        print("  cd inference && ./v.sh composer 'uvicorn app:app --host 0.0.0.0 --port 8001 --reload'")
