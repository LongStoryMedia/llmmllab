...
def test_intent_analysis_schema():
    ...
    try:
        ...
        print(
            f"  ✅ Successfully created: {analysis.primary_intent} with complexity {analysis.complexity_level.value}"
        )
    ...
    try:
        ...
        print(
            f"     - Requirements: {[req.value for req in analysis.computational_requirements]}"
        )
    except Exception as e:
