...
async def test_llm_driven_intent_analysis():
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        try:
            ...
            print(f"     - Analysis profile ID: {conversation_ctx.user_config.model_profiles.analysis_profile_id}")
        ...
        print(f"     - Expected complexity range: {test_case['expected_complexity_general']}")
        ...
        mock_analysis = IntentAnalysis(
            ...
            required_capabilities=[RequiredCapability.WEB_SEARCH, RequiredCapability.REASONING],
