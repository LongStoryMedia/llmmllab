...
async def test_dynamic_tools_schema():
    ...
    try:
        ...
        logger.info("✅ DynamicTool model created successfully with all BaseTool fields")
        ...
        if retrieved_tool:
            ...
            assert retrieved_tool.handle_validation_error == test_tool.handle_validation_error
            assert retrieved_tool.response_format == test_tool.response_format
            
            logger.info("✅ All BaseTool interface fields preserved in database roundtrip")
