...
async def memory_retrieval_logic(
    ...
    try:
        ...
        conversation_filter = None if memory_config.get("enable_cross_conversation", True) else conversation_id
...
class TestMemoryRetrievalLogic:
    ...
    async def test_memory_logic_error_handling(self):
        ...
        mock_storage.search_similarity = AsyncMock(side_effect=Exception("Storage error"))
    ...
    async def test_cross_conversation_filtering(self):
        ...
        assert "Memory Search Results" in result_cross, "Should find memories with cross-conversation enabled"
    ...
    async def run_all_tests(self):
        ...
        logger.info(f"🎉 Memory Retrieval Logic Tests Complete: {passed_tests}/{total_tests} passed")
