...
type ChatReq struct {
	...
	Messages       []ChatMessage            `json:"messages" yaml:"messages"` // Messages to send to the model, each message is a struct with role and content
	...
	KeepAlive      *string                  `json:"keep_alive" yaml:"keep_alive"` // Controls how long the model will stay loaded into memory
