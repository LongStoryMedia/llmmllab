...
type ModelParameters struct {
	...
	Think         bool `protobuf:"varint,11,opt,name=think,proto3" json:"think,omitempty"`
...
func (x *ModelParameters) GetThink() bool {
	if x != nil {
		return x.Think
	}
	return false
...
const file_model_parameters_proto_rawDesc = "" +
	"\n" +
	"\x16model_parameters.proto\x12\x05proto\"\xb5\x02\n" +
	...
	"\x05min_p\x18\n" +
	" \x01(\x01R\x04minP\x12\x14\n" +
	"\x05think\x18\v \x01(\bR\x05thinkB\x0fZ\rmaistro/protob\x06proto3"
