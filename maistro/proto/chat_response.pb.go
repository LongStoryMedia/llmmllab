...
type ChatResponse struct {
	...
	Context []*ChatResponse_ContextList `protobuf:"bytes,5,rep,name=context,proto3" json:"context,omitempty"`
	// Specific indicator of how or why the generation finished
...
func (x *ChatResponse) GetContext() []*ChatResponse_ContextList {
	if x != nil {
		return x.Context
	}
	return nil
...
type ChatResponse_ContextList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ChatResponse_ContextList) Reset() {
	*x = ChatResponse_ContextList{}
	mi := &file_chat_response_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ChatResponse_ContextList) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChatResponse_ContextList) ProtoMessage() {}

func (x *ChatResponse_ContextList) ProtoReflect() protoreflect.Message {
	mi := &file_chat_response_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChatResponse_ContextList.ProtoReflect.Descriptor instead.
func (*ChatResponse_ContextList) Descriptor() ([]byte, []int) {
	return file_chat_response_proto_rawDescGZIP(), []int{0, 0}
}

func (x *ChatResponse_ContextList) GetValues() []float64 {
	if x != nil {
		return x.Values
	}
	return nil
...
const file_chat_response_proto_rawDesc = "" +
	"\n" +
	"\x13chat_response.proto\x12\x05proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\rmessage.proto\"\xbf\x05\n" +
	...
	"\acontext\x18\x05 \x03(\v2\x1f.proto.ChatResponse.ContextListR\acontext\x12I\n" +
	...
	"\reval_duration\x18\f \x01(\x01R\fevalDuration\x1a%\n" +
	"\vContextList\x12\x16\n" +
	"\x06values\x18\x01 \x03(\x01R\x06values\"\x84\x01\n" +
...
var file_chat_response_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_chat_response_proto_goTypes = []any{
	...
	(*ChatResponse_ContextList)(nil),   // 2: proto.ChatResponse.ContextList
	(*Message)(nil),                    // 3: proto.Message
	(*timestamppb.Timestamp)(nil),      // 4: google.protobuf.Timestamp
}
var file_chat_response_proto_depIdxs = []int32{
	3, // 0: proto.ChatResponse.message:type_name -> proto.Message
	4, // 1: proto.ChatResponse.created_at:type_name -> google.protobuf.Timestamp
	2, // 2: proto.ChatResponse.context:type_name -> proto.ChatResponse.ContextList
	0, // 3: proto.ChatResponse.finish_reason:type_name -> proto.ChatResponse.FinishReasonEnum
