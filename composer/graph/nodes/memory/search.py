...
from composer.models import Memory as MemoryModel
...
class MemorySearchNode:
    ...
    async def __call__(self, state: WorkflowState) -> WorkflowState:
        ...
        try:
            ...
            # Store retrieved memories in state (type: ignore due to type mismatch between server and model Memory)
            state.retrieved_memories = memories  # type: ignore
