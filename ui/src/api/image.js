 ...
 */
export const generateImage = async (accessToken, request) => req({
    method: 'POST',
 ...
 * @returns Promise that resolves with image data
 */
export const editImage = async (accessToken, request) => req({
    method: 'POST',
    headers: getHeaders(accessToken),
    path: `images/edit`,
    body: JSON.stringify(request)
 ...
 */
export const getUserImages = async (accessToken, limit, offset, conversationId) => {
