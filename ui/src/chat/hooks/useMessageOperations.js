...
import { getMessages, getManyConversations, deleteMessage, getToken } from '../../api';
import { MessageContentTypeValues } from '../../types/MessageContentType';
import { useAuth } from '../../auth';
export const useMessageOperations = (state, actions) => {
    const navigate = useNavigate();
    const auth = useAuth();
    /**
     * Fetch messages for a conversation
     */
    const fetchMessages = useCallback(async (conversationId, clearResponse = true) => {
