...
const ChatPage = memo(() => {
    const { messages, isTyping, isLoading, currentConversation, selectConversation, currentObserverMessages, streamingSections } = useChat();
    ...
    return (_jsxs(ChatPageContainer, { children: [_jsx(ChatContainer, { messages: messages, streamingMessage: streamingMessage }), _jsx(FloatingNotifications, { messages: currentObserverMessages }), _jsx(ChatInput, {})] }));
});
