...
k exec -it -n ollama $POD_NAME -- /app/v.sh [service] python [command]
...
**Completed:** Runner simplified to pure LLM interface, Composer handles all orchestration
**Key Change:** All `create_graph()` methods moved from runner to composer workflows